...
_CONTEXT_PATTERNS = [
    ...
    (r'cros', 'Cros', 'cros'),
    (r'marxa', 'Marxa', 'marxa'),
    (r'territorial|territcombi|cnatterrit|control|bai|bages|divirtiendose|jugando|lligueta|portaunamic|social|quadrangular|resultpromo|resultro', 'Promocio', '20'),
