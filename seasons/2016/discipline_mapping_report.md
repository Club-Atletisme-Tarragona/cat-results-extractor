# Discipline mapping report — season 2016
...
|---:|---|---|
| 128 | `LLANÇAMENT DE PES` | `Pes (3 Kg)` |
| 87 | `LLANÇAMENT DE PES` | `Pes (2 Kg)` |
| 41 | `LLANÇAMENT DE PES` | `Pes (4 Kg)` |
| 39 | `60m MASC. PC` | `60 metres llisos` |
| 39 | `Pes Infantil                                       2 kg` | `Pes (2 Kg)` |
| 37 | `Llargada FEM. PC` | `Llargada` |
| 36 | `Pes Cadet                             3 kg` | `Pes (3 Kg)` |
| 29 | `Llargada Benjamí Masculí` | `Llargada` |
| 28 | `Llargada Aleví Femení` | `Llargada` |
| 26 | `PROVA                LLARGADA ALEVÍ FEMENÍ` | `Llargada` |
| 25 | `60m FEM. PC` | `60 metres llisos` |
| 25 | `Llargada Infantil Femení` | `Llargada` |
| 24 | `PROVA       PES ALEVÍ FEMENÍ                                               PES      2 kg` | `Pes (2 Kg)` |
| 23 | `LLARGADA Infantil Femení` | `Llargada` |
| 23 | `Pes Infantil Femení                           2 Kg` | `Pes (2 Kg)` |
| 22 | `Javelina Juvenil Femení                                   500 gr.` | `Javelina (500g)` |
| 22 | `Pes Infantil Masculí                          3 kg` | `Pes (3 Kg)` |
| 20 | `60 METRES LLISOS` | `60 metres llisos` |
| 20 | `Llargada   Punts        Javelina   Punts      200 m.       Punts      Disc     Punts    1.500 m.   Punts` | `Llargada` |
| 20 | `Llargada CADET FEMENÍ` | `Llargada` |
| 20 | `Pes (3kg) CADET FEMENÍ` | `Pes (3 Kg)` |
| 20 | `Pes FEM. PC` | `Pes (4 Kg)` |
...
| 11 | `Llargada Benjamí Femení` | `Llargada` |
| 11 | `PROVA              LLARGADA BENJAMÍ MASCULÍ` | `Llargada` |
| 11 | `Pes (2Kg)` | `Pes (2 Kg)` |
| 11 | `Pes (3,00 Kg) VET. Fem. PC 50-54` | `Pes (3 Kg)` |
...
| 10 | `Llargada Cadet Masculí` | `Llargada` |
| 10 | `Pes Juvenil                                     5 kg` | `Pes (5 Kg)` |
| 10 | `Prova:         MARTELL                 ABSOLUT FEMENÍ` | `Martell (4 Kg)` |
...
| 6 | `5000 METRES MARXA CADET MASCULI` | `5000 metres marxa` |
| 6 | `Alçada FEM. PC` | `Alçada` |
| 6 | `Disc Cadet Femení                           800 gr.` | `Disc (800 g)` |
| 6 | `Disc VET. Fem. 40-44` | `Disc (1 Kg)` |
| 6 | `Disco (800g) FEM.` | `Disc (800 g)` |
| 6 | `Javelina Infantil Masculí                                 500 gr.` | `Javelina (500g)` |
| 6 | `Javelina Júnior (800g) MASC.` | `Javelina (800 g)` |
| 6 | `Javelina Vet. MAS. 45-49` | `Javelina (800 g)` |
| 6 | `LLANÇAMENT DE JAVELINA` | `Javelina (600 g)` |
| 6 | `LLANÇAMENT DE JAVELINA JUVENIL MASCULI` | `Javelina (700 g)` |
| 6 | `LLANÇAMENT DE PES CADET FEMENI` | `Pes (3 Kg)` |
| 6 | `LLANÇAMENT DE PES FEMENI` | `Pes (4 Kg)` |
...
| 5 | `LLANÇAMENT DE JAVELINA FEMENI` | `Javelina (600 g)` |
| 5 | `LLANÇAMENT DE MARTELL PESAT FEMENI` | `Martell (4 Kg)` |
| 5 | `LLANÇAMENT DE PES MASCULÍ` | `Pes (7.260 Kg)` |
| 5 | `LLANÇAMENT DEL PES FEMENI ( PENTATLÓ )` | `Pes (4 Kg)` |
| 5 | `LLARGADA ALEVI MASCULI` | `Llargada` |
| 5 | `LLARGADA CADET FEMENI` | `Llargada` |
| 5 | `LLARGADA PROMESA FEMENI` | `Llargada` |
| 5 | `Llargada aleví masc.` | `Llargada` |
| 5 | `Longitud MASC. AL` | `Llargada` |
| 5 | `Martell Juvenil-Cadet (3kg) FEM.` | `Martell (3 Kg)` |
| 5 | `Martell VET. Fem. 40-44` | `Martell (4 Kg)` |
...
| 4 | `Javelina Vet. MAS. 60-64` | `Javelina (800 g)` |
| 4 | `LLANÇAMENT DE DISC FEMENI` | `Disc (1 Kg)` |
| 4 | `LLARGADA Cadet Masculí` | `Llargada` |
| 4 | `LLARGADA FEM` | `Llargada` |
| 4 | `Llargada 2001 FEM. PC` | `Llargada` |
| 4 | `Llargada FEM. AL` | `Llargada` |
| 4 | `Llargada FEM. PC 45-49` | `Llargada` |
| 4 | `Llargada Fem.` | `Llargada` |
| 4 | `Llargada MASC. AL 50-54` | `Llargada` |
...
| 3 | `Javelina (600g) FEM.` | `Javelina (600 g)` |
| 3 | `Javelina Absolut                            800 g` | `Javelina (800 g)` |
| 3 | `Javelina FEM.` | `Javelina (600 g)` |
| 3 | `Javelina MASC.` | `Javelina (800 g)` |
| 3 | `LLANÇAMENT DE MARTELL FEMENI` | `Martell (4 Kg)` |
| 3 | `LLARGADA                            IF-AF-BF` | `Llargada` |
| 3 | `Llargada FEM. AL 35-39` | `Llargada` |
| 3 | `Llargada Juvenil Femení` | `Llargada` |
| 3 | `Llargada MASC. AL 35-39` | `Llargada` |
| 3 | `Llargada MASC. AL ALEVI` | `Llargada` |
| 3 | `Llargada MASC. ALE AL` | `Llargada` |
| 3 | `Longitud FEM. AL` | `Llargada` |
| 3 | `PES FEM` | `Pes (4 Kg)` |
| 3 | `PROVA       LLARGADA BF` | `Llargada` |
| 3 | `PROVA      PES ALEVÍ FEMENÍ                                                  PES            2 kg` | `Pes (2 Kg)` |
| 3 | `PROVA     MARTELL ABSOLUT F                                     PES             4 KG` | `Martell (4 Kg)` |
| 3 | `PROVA    LLARGADA AM - IM` | `Llargada` |
| 3 | `Pes (2kg) ALE MASC. AL` | `Pes (2 Kg)` |
| 3 | `Pes (3kg) FEM. PC` | `Pes (3 Kg)` |
| 3 | `Pes (6 KG) MASC. PC 50-54` | `Pes (6 Kg)` |
| 3 | `Pes (7,260 KG) MASC. PC 35-39` | `Pes (7.260 Kg)` |
| 3 | `Pes Absolut                                     7,260 kg` | `Pes (7.260 Kg)` |
| 3 | `Pes Absolut                              4 kg` | `Pes (4 Kg)` |
| 3 | `Pes Fem.` | `Pes (4 Kg)` |
| 3 | `Pes Juvenil                              3 kg` | `Pes (3 Kg)` |
| 3 | `Pes Vet. M65 PC` | `Pes (6 Kg)` |
...
| 2 | `Alçada` | `Alçada` |
| 2 | `Alçada ALEVI MASCULI` | `Alçada` |
| 2 | `Alçada MASC. PC` | `Alçada` |
| 2 | `Alçada aleví masc.` | `Alçada` |
| 2 | `DISC Cadet Femení                                     800 g` | `Disc (800 g)` |
...
| 2 | `LLARGADA ALEVÍ MASCULÍ` | `Llargada` |
| 2 | `LLARGADA Absolut Femení` | `Llargada` |
| 2 | `LLARGADA Absolut Masculí` | `Llargada` |
| 2 | `LLARGADA BENJAMI MASCULI` | `Llargada` |
| 2 | `Llargada ALE MASC. AL` | `Llargada` |
| 2 | `Llargada ALEVI MASCULI` | `Llargada` |
| 2 | `Llargada Aleví Masculí` | `Llargada` |
...
| 2 | `Pentatló Femení Infantil` | `Pentatló` |
| 2 | `Pes Infantil Femení (2Kg)` | `Pes (2 Kg)` |
| 2 | `RESULTATS SALT D'ALÇADA FEMENINA` | `Alçada` |
| 2 | `RESULTATS TRIPLE SALT CADET ABSOLUT FEMENÍ` | `Triple` |
| 2 | `SALT D'ALÇADA FEMENI ( PENTATLÓ )` | `Alçada` |
...
| 1 | `10000 METRES LLISOS VETERÀ MASCULÍ` | `10000 metres llisos` |
...
| 1 | `ALÇADA PROMESA FEMENI` | `Alçada` |
| 1 | `Alçada Fem.` | `Alçada` |
...
| 1 | `PROVA     MARTELL ABSOLUT F                                     PES              4 KG` | `Martell (4 Kg)` |
